...
/// 英雄状态
/// </summary>
public class HeroStatus : StatusComponent
{
    /// <summary>
    /// 血条父对象
    /// </summary>
    ...
    public HeroStatus(GameObject hpParent, GameObject attackCBg, Image hp, Image attackCd, HeroEntity entity)
    {
